...
function create(params, cb) {
	...
	if (params.workspace) {
		if (params.workspace !== 'none' && !params.workspace.startsWith('https://') && !params.workspace.startsWith('git@')) {
    ...
    zip.writeZip(zip_file);
		...
		if (params.workspace.startsWith('https://') || params.workspace.startsWith('git@')) params.workspaceFileName = params.workspace;
		...
		if (params.workspace === 'none' || params.workspace.startsWith('https://') || params.workspace.startsWith('git@')) delete params.workspace;
	}
