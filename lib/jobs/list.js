 ...
 * @param {string} [filter.project] - Optional; The name of the project for this job.  If neither project nor projectId are provided, this is taken from the .ps_project/config.json file, or the current directory name.
