 ...
 * @param {string} [params.templateId] - Required template id of the template to use for creating this machine
 ...
 * @param {string} [params.notificationEmail] - Send a notification to this email address when the machine is created
 ...
 *   userId: 'u123abc', // optional - required if assigning this machine to an existing user; omit if creating a new user
 ...
 *   notificationEmail: 'example@example.com', // optional - to email address to send a notification to when the machine is created
 * }, function(err, resp) {
